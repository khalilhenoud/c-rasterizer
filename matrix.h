 ...
 * > A Matrix4D is made of 16 floats:	0	4	8	12
 * >	 								1	5	9	13  
 * >  									2	6	10	14  
 * > 									3	7	11	15
 * 
 ...
 * matrices m1 * m2 * m3, the geometric interpretation of the result is that the transformation
 * of m3 is applied first followed by m2 and finally m1.
 * 
...
/**
 * Axis angle matrix.
 * @remarks	Check out CS 250 transformations chapter and xin li notes (Orientation.doc) for the
 * 			information on the logic behind the transformations. It is actually three
 ...
 * @remarks	Normalizes 'u' and calculate the matrix that will give the resulting vector if 'u'
 * 			were to be crossed with it.
